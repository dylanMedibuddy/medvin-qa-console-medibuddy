...
-- 1. Migrate existing rows to the new status values.
...
-- 2. Replace the CHECK constraint with the new allowed values.
...
-- 3. Replace the partial unique index. The "active" set (where dupes are not allowed)
